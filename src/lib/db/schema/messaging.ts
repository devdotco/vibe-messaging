...
export const messages = pgTable('messages', {
  ...
  hasHereMention: boolean('has_here_mention').default(false),
  hasChannelMention: boolean('has_channel_mention').default(false),
  forwardedFromMessageId: uuid('forwarded_from_message_id'),
  forwardedFromChannelId: uuid('forwarded_from_channel_id'),
